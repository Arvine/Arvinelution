...
function c810000012.desfilter(c)
	return c:IsType(TYPE_MONSTER)
end
function c810000012.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c810000012.desfilter,tp,LOCATION_MZONE,0,1,nil) end
