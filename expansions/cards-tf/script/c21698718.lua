...
function c21698718.initial_effect(c)
	...
	e4:SetCondition(c21698718.descon)
	c:RegisterEffect(e4)
end
function c21698718.descon(e)
...
function c21698718.returntg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsOnField() and chkc:IsControler(tp) and c21698718.returnfilter(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c21698718.returnfilter,tp,LOCATION_ONFIELD,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TODECK)
	local g=Duel.SelectTarget(tp,c21698718.returnfilter,tp,LOCATION_ONFIELD,0,1,1,nil)
