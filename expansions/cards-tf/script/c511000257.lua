...
function c511000257.initial_effect(c)
	...
	c:SetUniqueOnField(1,1,511000257)
	...
	e10:SetDescription(aux.Stringid(511000257,1))
	e10:SetProperty(EFFECT_FLAG_NO_TURN_RESET+EFFECT_FLAG_CANNOT_DISABLE)
	e10:SetType(EFFECT_TYPE_QUICK_O)
	e10:SetRange(LOCATION_MZONE)
	e10:SetCountLimit(1)
	e10:SetCode(EVENT_FREE_CHAIN)
	e10:SetTarget(c511000257.untg)
	...
	e16:SetValue(c511000257.unaffectedval)
	c:RegisterEffect(e16)
	--A God who Erases Another God
	local e17=Effect.CreateEffect(c)
	e17:SetDescription(aux.Stringid(511000257,0))
	e17:SetCategory(CATEGORY_DESTROY)
	e17:SetProperty(EFFECT_FLAG_UNCOPYABLE+EFFECT_FLAG_IGNORE_IMMUNE)
	e17:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e17:SetCode(EVENT_TO_GRAVE)
	e17:SetTarget(c511000257.erasetg)
	e17:SetOperation(c511000257.eraseop)
...
function c511000257.tgset(e,c)
return c:IsRace(RACE_DEVINE)
end
function c511000257.atkdef(e,c)
	return Duel.GetFieldGroupCount(c:GetControler(),0,LOCATION_ONFIELD)*1000
end
function c511000257.unaffectedval(e,te)
...
function c511000257.untg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return true end
	local e2=Effect.CreateEffect(c)
	e2:SetType(EFFECT_TYPE_SINGLE)
	...
	e2:SetValue(c511000257.efilter)
