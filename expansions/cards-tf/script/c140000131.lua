...
function c140000131.initial_effect(c)
        --fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCodeFun(c,71625222,c140000131.ffilter,1,true,true)
	--spsummon condition
	...
	e3:SetValue(c140000131.eqlimit)
	c:RegisterEffect(e3)
end
function c140000131.eqlimit(e,c)
        return c:IsFaceup()
end
function c140000131.ffilter(c)
