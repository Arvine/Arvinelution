...
function c511000162.tgfilter(c)
	return c:IsAbleToHand()
end
function c511000162.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_REMOVED) and chkc:IsControler(tp) and c511000162.tgfilter(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c511000162.tgfilter,tp,LOCATION_REMOVED,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local sg=Duel.SelectTarget(tp,c511000162.tgfilter,tp,LOCATION_REMOVED,0,1,1,nil)
