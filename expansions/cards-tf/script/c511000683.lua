...
function c511000683.eqlimit(e,c)
	return (c:IsCode(51543904) or c:IsCode(21521304) or c:IsCode(65305468) or c:IsCode(67926903))
end
function c511000683.filter(c)
	return c:IsFaceup() and (c:IsCode(51543904) or c:IsCode(21521304) or c:IsCode(65305468) or c:IsCode(67926903))
end
